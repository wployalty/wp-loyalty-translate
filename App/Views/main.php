...
<div id="wlt-main">
    ...
    <div class="wlt-main-header">
        <h1><?php echo esc_html__( 'WPLoyalty - Multi-Lingual Compatibility - Dynamic Strings',
				'wp-loyalty-translate' ); ?> </h1>
        <div><b><?php echo esc_html( 'v' . WLT_PLUGIN_VERSION ); ?></b></div>
    </div>
    <div class="wlt_content">
        <div class="wlt-sections">
            <div class="title">
                <h3><?php esc_html_e( 'Loco Translate:', 'wp-loyalty-translate' ); ?></h3>
            </div>
            <div class="content">
                ...
                <p><?php echo wp_kses_post( __( 'You can now translate the dynamic content like Campaign title, descriptions, reward title, description, content inside the Launcher widget easily.',
						'wp-loyalty-translate' ) ); ?></p>
            </div>
        </div>
        <div class="wlt-sections">
            <div class="title">
                <h3><?php esc_html_e( 'WPML Translate:', 'wp-loyalty-translate' ); ?></h3>
            </div>
            <div class="content">
				...
				<?php if ( isset( $is_wpml_translate_string_available ) && $is_wpml_translate_string_available ): ?>
                    <div class="wlt_button">
                        ...
                        ><?php esc_html_e( 'Update Dynamic String for WPML', 'wp-loyalty-translate' ); ?></a>
                    </div>
				<?php endif; ?>
            </div>
        </div>
